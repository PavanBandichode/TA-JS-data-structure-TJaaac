...
for(let house of got.houses){
  for(let fullname of got.houses[0].people)
  console.log(fullname.name);
}
// 5. Log the name of all the people in house Lannisters (index 1) one by one
for(let house of got.houses){
  for(let fullname of got.houses[1].people)
  console.log(fullname.name);
}
...
for(let house of got.houses){
  for(let fullname of got.houses[1].people)
  console.log(`I am ${fullname.name} and my bio is ${fullname.description}`);
}
