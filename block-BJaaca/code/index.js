...
let character={
    ...
    age:20,
    greet:function greet(){alert (`She is ${characterName} and her title is  ${title}`);}
...
character.greet= function greet(){alert (`I am ${characterName} and my title is ${title}`)}
